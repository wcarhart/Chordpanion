...
struct Note {
    ...
    init?(name: String) {
        ...
        case "b#", "c", "dbb":
            self.value = 0
            print("LOG: initializing new note with value \(self.value) (B#, C, Dbb)")
        case "b##", "c#", "db":
            self.value = 1
            print("LOG: initializing new note with value \(self.value) (B##, C#, Db)")
        case "c##", "d", "ebb":
            self.value = 2
            print("LOG: initializing new note with value \(self.value) (C##, D, Ebb)")
        case "d#", "eb", "fbb":
            self.value = 3
            print("LOG: initializing new note with value \(self.value) (D#, Eb, Fbb)")
        case "d##", "e", "fb":
            self.value = 4
            print("LOG: initializing new note with value \(self.value) (D##, E, Fb)")
        case "e#", "f", "gbb":
            self.value = 5
            print("LOG: initializing new note with value \(self.value) (E#, F, Gbb)")
        case "e##", "f#", "gb":
            self.value = 6
            print("LOG: initializing new note with value \(self.value) (E#E, F#, Gb)")
        case "f##", "g", "abb":
            self.value = 7
            print("LOG: initializing new note with value \(self.value) (F##, G, Abb)")
        case "g#", "ab":
            self.value = 8
            print("LOG: initializing new note with value \(self.value) (G#, Ab)")
        case "g##", "a", "bbb":
            self.value = 9
            print("LOG: initializing new note with value \(self.value) (G##, A, Bbb)")
        case "a#", "bb", "cbb":
            self.value = 10
            print("LOG: initializing new note with value \(self.value) (A#, Bb, Cbb)")
        case "a##", "b", "cb":
            self.value = 5
            print("LOG: initializing new note with value \(self.value) (A##, B, Cb)")
        default:
            print("ERROR: could not initialize note with name \(name)")
            return nil
        }
    }
